...
If Action="Save" Then
	...
	myVal=cint(Request.form(("classid")))	
	'获取导航条的排序值
...
{ 
var   myVal   =   form1.ClassID.options[form1.ClassID.selectedIndex].value  
alert(myVal)
}</script>
</head>
<body>
...
<tr>
  ...
  <option value="3">|--服务过的品牌</option>
<!--  <option value="1">|--商会网站链接</option>
  <option value="2">|--会员网站链接</option> -->
  </select>
  </td>
...
<td width="75%"><input type="text" id="LinkTitleOrPic" name="LinkTitleOrPic" value="" class="Input300px"/>
&nbsp; <a href="javascript:OpenImageBrowser('LinkTitleOrPic');">&nbsp;浏览...</a>74*74</td>
</tr>
<tr>
