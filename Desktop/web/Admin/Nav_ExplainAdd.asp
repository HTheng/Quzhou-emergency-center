...
<td colspan="3"><input type="text" id="NavRemark" name="NavRemark" value="" class="Input300px"/></td>
 ...
 <!--<tr>
  ...
  <div class="float_left_60"></div></td>
...
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
 ...
 <div class="float_left_90">英文描述</div>
  <%=Editor2("EnNavContent","")%>
  <span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&EnFrameName=EnNavContent&FrameName=NavContent"></script>
  <%end if%>
</td>
</tr>
<tr>
