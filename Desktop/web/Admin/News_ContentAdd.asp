...
<tr>
<td class="Right" align="right" width="14%">信息标题：</td>
...
<td colspan="2" class="Right"><input type="text" id="NewsSPic" name="NewsSPic" readonly="readonly" value="" class="Input200px" style="background-color:#F5F5F5;"/> 
<a href="javascript:OpenImageBrowser('NewsSPic');">浏览...</a> 120*160   &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><input type="text" id="NewsBPic" name="NewsBPic" readonly="readonly" value="" class="Input200px" style="background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('NewsBPic');">浏览...</a> 大图：300*300</td>
</tr>
<!--<tr>
