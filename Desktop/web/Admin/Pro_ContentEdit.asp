...
<tr>
<td class="Right" align="right" width="10%">产品名称：</td>
<td class="Right">
...
<td class="Right" width="9%" align="right">栏目类别：</td>
<td width="43%">
...
<td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="ShopSPic" name="ShopSPic" value="<%=ShopSPic%>" class="Input200px"/> 
  ...
  <div class="picsize_left_90" style="width:400px;">产品：132x132；新产品：120x100；生产环境：225x148</div></td>
</tr>

<tr>
<td class="Right" align="right">大图 ：</td>
<td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="ShopBPic" name="ShopBPic" value="<%=ShopBPic%>" class="Input200px"/> 
  <a href="javascript:OpenImageBrowser('ShopBPic');">浏览...</a></div>
  <div class="picsize_left_91" style="width:400px;">&nbsp;产品：650x650；新产品：650x540；生产环境：650x428</div></td>
</tr> 
<!--<tr>
<td class="Right" align="right">产品编号：</td>
<td class="Right"><input type="text" id="ShopSerial" name="ShopSerial" value="<%=ShopSerial%>" class="Input200px"/></td>
<td class="Right" align="right">产品规格：</td>
<td>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
  <div class="float_left_210txt">
...
<tr>
 <!-- <td align="right" class="Right">商品规格：</td>
  ...
  <td align="right" class="Right">产品型号：</td>
