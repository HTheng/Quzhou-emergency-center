...
<tr>
  ...
  <td colspan="2" class="Right"><input type="text" id="NewsSPic" name="NewsSPic" readonly="readonly" value="<%=NewsSPic%>" class="Input200px" style="background-color:#F5F5F5;"/> 
  <a href="javascript:OpenImageBrowser('NewsSPic');">浏览...</a> 120*160 图片新闻 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
  <td> <input type="text" id="NewsBPic" name="NewsBPic" readonly="readonly" value="<%=NewsBPic%>" class="Input200px" style="background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('NewsBPic');">浏览...</a>  大图：300×300</td>
</tr>
<tr>
...
<td colspan="3"><%=Editor2("NewsContent",NewsContent)%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NewsContent"></script>
