...
<tr>
  ...
  <td colspan="2" class="Right"><input type="text" id="NewsSPic" name="NewsSPic" readonly="readonly" value="<%=NewsSPic%>" class="Input200px" style="background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('NewsSPic');">浏览...</a> 200*148 图片新闻268×180<!--信息大图：--></td>
