...
If Action="Save" Then
	...
	Sql="Select AdsOrder From SiteAds Where AdsType='Banner' Order By AdsOrder Desc"
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u6a2a\u5e45\u5e7f\u544a\u6dfb\u52a0\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='AD_Banner.asp';</script>")
	Response.End()
End If
%>
...
<!--<tr>
<td height="36" align="right" class="Right">广告类型：</td>
...
<tr id="Pic1">
<td class="Right" width="25%" align="right">小图：</td>
<td width="38%"><input type="text" id="AdsSwfUrl" name="AdsSwfUrl" class="Input300px"></td>
<td width="37%"><input type="button" value="浏览图片" class="Button" onclick="OpenImageBrowser('AdsSwfUrl');"/>62*25</td>
</tr>-->
<tr id="Pic1">
<td class="Right" width="25%" align="right">图片地址：</td>
<td width="38%"><input type="text" id="AdsPicUrl" name="AdsPicUrl" class="Input300px"></td>
<td width="37%"><input type="button" value="浏览图片" class="Button" onclick="OpenImageBrowser('AdsPicUrl');"/> 208*149</td>
</tr>
<tr id="Pic2">
