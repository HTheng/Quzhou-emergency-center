...
<td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="ShopSPic" name="ShopSPic" value="<%=ShopSPic%>" class="Input200px"/> 
  ...
  <div class="picsize_left_90">150X110</div></td>
</tr>

<tr>
<td class="Right" align="right">大图/上传视频：</td>
<td class="Right"><div class="float_left_250txt"><input type="text" id="ShopBPic" name="ShopBPic" value="<%=ShopBPic%>" class="Input200px"/> 
   <a href="javascript:OpenImageBrowser('ShopBPic');">浏览...</a></div>
<div class="picsize_left_90">266X266</div></td>
