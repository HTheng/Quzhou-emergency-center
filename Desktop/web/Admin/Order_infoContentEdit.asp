...
If ReplaceBadChar(Trim(Request("Action")))="Save" Then
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u4fe1\u606f\u5206\u7c7b\u4fe1\u606f\u6dfb\u52a0\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='Order_class.asp';</script>")
	Response.End()
...
If Not (Rs.Bof Or Rs.Eof) Then
	...
	img=Rs("img")
	recordContent=Rs("recordContent")
End If
Rs.Close
Set Rs=Nothing
%>
...
<tr>
  ...
  <input type="text" id="number" name="number" value="<%=numbers%>" class="Input200px"/>
  </div>
  </td>
</tr>
<tr>
 <td   align="right" class="Right">订单时间：</td>
  <td width="60%"> 
    <div class="float_left_210" >
  <input type="text" id="posttime" name="posttime" value="<%=posttime%>" class="Input200px"  />
   </div>(格式：2012-3-18)
       </td>
</tr>
<tr>
  <td class="Right" align="right">图片：</td>
  <td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="img" name="img" value="<%=img%>" class="Input200px"/>    
...
<tr>
  ...
  <td colspan="3" align="left" valign="top">     
		...
		<%=Editor2("recordContent",recordContent)%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span>
