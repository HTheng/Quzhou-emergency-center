...
<th width="17%" class="Right">留言</th>
<th width="13%" class="Right">联系人姓名</th>
<th width="28%" class="Right">联系地址</th>

<th width="22%" class="Right">邮箱</th>

<th width="6%" class="Right"><input type="checkbox" name="chkSelectAll" onclick="doCheckAll(this)" /></th>
<th width="9%" class="Right">管理操作</th>
</tr>
<%
...
<%
	if len(Trim(Rs("GuestbookContent")))>20 then
	Response.Write(left(Trim(Rs("GuestbookContent")),15)&"...")
	else
	Response.Write(Trim(Rs("GuestbookContent")))
	end if
%></a>
</td>
<td class="Right"><%
