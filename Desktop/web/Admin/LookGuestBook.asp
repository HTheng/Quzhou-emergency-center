...
<tr>
  <td class="Right" align="right" valign="top">Fax：</td>
  <td width="75%"><input type="text" id="Fax" name="Fax" value="<%=Fax%>" readonly="readonly" class="Input300px"/></td>
</tr>
<tr>
<tr>
  <td class="Right" align="right" valign="top">公司名称：</td>
...
<tr>
  <td class="Right" align="right" valign="top">国家：</td>
...
<tr>
  <td class="Right" align="right" valign="top">QQ/MSN：</td>
  <td width="75%"><input type="text" id="ICQ" name="ICQ" value="<%=ICQ%>" readonly="readonly" class="Input300px"/></td>
</tr>-->
<tr>
