...
<tr>
  <td width="10%" align="right" class="Right">产品名称：</td>
  <td class="Right">
...
<tr>
  ...
  <div class="picsize_left_90" style="width:400px;">产品：132x132；新产品：120x100；生产环境：225x148</div></td><!--class="picsize_left_90"-->
  </tr>
<tr>
  <td class="Right" align="right">大图：</td>
  <td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="ShopBPic" name="ShopBPic" value="" class="Input200px"/>    
...
<tr>
  <td align="right" class="Right">产品描述：</td>
