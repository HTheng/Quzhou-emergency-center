...
<div class="Navigation_top">你所在的位置：<a href="index.asp" title="首页">首页</a> <%=GetNavnews2("newsclass",classid)%></div>
  <div class="right_frame_2">
                  <div class="right_top_2">>急救动态</div>
                      <div class="news_content">
                        ...
                        %>  
                             <li><span style=" float:right;"><%=GetPostTimeL(rs("ID"))%></span><a href="Dynamic_detail.asp?id=<%=rs("id")%>&classid=<%=rs("classid")%>" title="<%=rs("NewsTitle")%>" target="_blank"><%
