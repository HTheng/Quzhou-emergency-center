...
If Action="Save" Then
	...
	Sql="Select AdsOrder From SiteAds Where AdsType='Pop' Order By AdsOrder Desc"
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u5f39\u51fa\u5e7f\u544a\u6dfb\u52a0\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='AD_Pop.asp';</script>")
	Response.End()
End If
%>
...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：弹出广告 >> 添加广告</td>
...
<td colspan="2"><input type="submit" value="保 存" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='AD_Pop.asp'"></td>
</tr>
</table>
</form>
</td>
