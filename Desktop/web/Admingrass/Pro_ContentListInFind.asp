...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Pro_ContentListIn.asp">商品管理</a> >> <a href="Pro_ContentListIn.asp">上架商品</a> >> 查找商品</td>
...
<form id="form1" name="form1" method="post" action="Pro_ContentListIn.asp?ClassID=<%=ClassID%>&ShowType=<%=ShowType%>">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="Form">
<tr>
<th colspan="2">上架商品查找</th>
</tr>
<tr>
...
<td width="75%"><input type="submit" value="查 找" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='Pro_ContentListIn.asp?ClassID=<%=ClassID%>&ShowType=<%=ShowType%>'"></td>
</tr>
</table>
</form>
</td>
