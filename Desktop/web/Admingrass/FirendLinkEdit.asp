...
<td width="75%"><input type="text" id="LinkTitleOrPic" name="LinkTitleOrPic" value="<%=LinkTitleOrPic%>" class="Input300px"/>&nbsp;*<a href="javascript:OpenImageBrowser('LinkTitleOrPic');">&nbsp;浏览...</a> 1000*299</td>
</tr>
--><tr>
