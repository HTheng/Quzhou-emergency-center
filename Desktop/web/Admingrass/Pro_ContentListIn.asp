...
<tr>
<td style="border-bottom:solid 1px #dde4e9;height:30px;width:80%">当前位置：<a href="Pro_ContentListIn.asp">图片维护</a>
<%
If ShopName<>"" Then
...
<th width="31%" class="Right">商品名称<a href="#" onclick="top.CreateNewTab('Pro_ContentAdd.asp?ClassID=<%=ClassID%>','Pro_ContentAdd','添加商品')">[+]</a></th>
<th width="27%" class="Right">商品类别</th>
<th width="8%" class="Right">商品排序</th>
<th width="7%" class="Right">新款上市</th>
...
Response.Write("<a href=""?Action=InNewLock&ID="&Rs("ID")&""">新款推荐</a>")
Else
