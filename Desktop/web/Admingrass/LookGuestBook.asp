...
If Action="Save" Then
	...
	Sex=ReplaceBadChar(Trim(Request("Sex")))
	...
	PostTime=ConvertDate(Trim(Request("PostTime")))
	...
	Conn.Close
	Set Conn=Nothing
	Response.Write("<script>alert('\u5bfc\u822a\u6761\u4fe1\u606f\u4fee\u6539\u64cd\u4f5c\u6210\u529f\u3002');window.location.href='GuestBook.asp';</script>")
	Response.End()
End If
%>
...
<tr>
<td class="Right" align="left" valign="middle" colspan="2"><input type="submit" value="提 交" class="Button"> <input type="button" value="返 回" class="Button" onClick="window.location.href='GuestBook.asp?ID=<%=ParentID%>&Page=<%=Page%>'"></td>
</tr>
<tr>
...
<!--<tr>
<td class="Right" width="25%" align="right" valign="top">性别：</td>
<td width="75%"><input type="text" id="Sex" name="Sex" value="<%=Sex%>" readonly="readonly" class="Input300px"/></td>
</tr>-->
<tr>
...
<!--<tr>
  <td class="Right" align="right" valign="top">类别：</td>
  <td width="75%"><input type="text" id="CompanyName" name="CompanyName" value="<%=CompanyName%>" readonly="readonly" class="Input300px"/></td>
</tr>-->
<tr>
...
<!--<tr>
  <td class="Right" align="right" valign="top">数量：</td>
...
<!--<tr>
  ...
  <td width="75%"><%=Editor2("Reply",Reply)%><script src="AutoSave.asp?Action=AutoSave&FrameName=Reply"></script></td>
</tr>-->
<tr>
