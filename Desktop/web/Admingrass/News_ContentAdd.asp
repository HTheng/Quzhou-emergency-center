...
<tr>
<td class="Right" align="right" width="10%">信息标题：</td>
<td class="Right" width="34%">
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
  <div class="float_left_210txt">
    <input type="text" id="NewsTitle" name="NewsTitle" value="" class="Input200px"/>
  </div>
 <%end if%>
 <%if Request.Cookies("CNVP_CMS2")("SiteVersion")="English" then%>
  <div class="float_left_210txt">
  <input type="text" id="EnNewsTitle" name="EnNewsTitle" value="" class="Input200px"/>
  </div>
  <%end if%>
...
<tr>
<td class="Right" align="right">信息图片：</td>
<td class="Right"><input type="text" id="NewsSPic" name="NewsSPic" readonly="readonly" value="" class="Input200px" style="background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('NewsSPic');">浏览...</a> 300*233</td>
...
<tr>
<td class="Right" align="right">来源：</td>
<td class="Right"><input type="text" id="NewsAuthor" name="NewsAuthor" value="转载" class="Input200px"/></td>
...
<tr>
  ...
  <td colspan="3" class="Right"><input type="text" id="UpLoadAddress" name="UpLoadAddress" readonly="readonly" value="" class="Input300px" style="width:500px; background-color:#F5F5F5;"/><a href="javascript:OpenImageBrowser('UpLoadAddress');">浏览</a>...(注意：上传下载文件 RAR格式)</td>
  </tr>
<tr>
<td class="Right" align="right" valign="top">信息内容：</td>
<td colspan="3">
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
  <%=Editor2("NewsContent","")%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NewsContent"></script>
<%end if%>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="English" then%>
  <%=Editor2("EnNewsContent","")%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=EnNewsContent"></script>
<%end if%>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="CAndE" then%>
  <div class="float_left_110" align="center">中文描述</div>
  <%=Editor2("NewsContent","")%>
  <div class="float_left_110" align="center">英文描述</div>
  <%=Editor2("EnNewsContent","")%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NewsContent"></script>
<%end if%></td>
</tr>
<!--<tr>
