...
GV.menus[2] =	[
				["添加图片","CreateNewTab('Pro_ContentAdd.asp','Pro_ContentAdd','添加图片')","2","2"],
				["上架图片维护","CreateNewTab('Pro_ContentListIn.asp','Pro_ContentListIn','图片维护')","2","2"],
				//["下架商品维护","CreateNewTab('Pro_ContentListOut.asp','Pro_ContentListOut','下架商品维护')","2","2"],
				["图片类别维护","CreateNewTab('Pro_Class.asp','Pro_Class','图片类别维护')","2","2"]
...
GV.menus[6]=	[
				...
				//["人才列表","CreateNewTab('Job_Person.asp','Job_Peroson','人才列表')","2","2"]
				];
...
GV.menus[8]=	[
				["友情链接添加","CreateNewTab('FirendLinkAdd.asp','Firend_Link','友情链接添加')","2","2"],
				["友情链接管理","CreateNewTab('FirendLink.asp','FirendLinkManager','友情链接管理')","2","2"]
				];
<%if Request.Cookies("CMS_CNVP")("ISAdmin")="true" then%>
GV.menus[9]=	[
...
<div id="buttom">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td class="copyright">Copyright &copy; 2005-<%=Year(Now())%> <a href="http://www.cnvp.com.cn" target="_blank" style="color:#93a1ab">温州市捷点信息技术有限公司</a> All Rights Reserved.&nbsp;&nbsp;&nbsp;&nbsp;客服热线：0577-85505501</td>
