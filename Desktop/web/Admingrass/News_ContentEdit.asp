...
<tr>
  ...
  <td class="Right"><input type="text" id="NewsSPic" name="NewsSPic" readonly="readonly" value="<%=NewsSPic%>" class="Input200px" style="background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('NewsSPic');">浏览...</a>  300*233</td>
...
<td colspan="3">
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" then%>
<%=Editor2("NewsContent",NewsContent)%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NewsContent"></script>
<%end if%>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="English" then%>
  <%=Editor2("EnNewsContent",EnNewsContent)%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=EnNewsContent"></script>
<%end if%>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="CAndE" then%>
  <div class="float_left_90" align="center">中文描述</div>
<%=Editor2("NewsContent",NewsContent)%>
  <div class="float_left_90" align="center">英文描述</div>
<%=Editor2("EnNewsContent",EnNewsContent)%><span id="timemsg"></span><span id="msg2"></span><span id="msg"></span><script src="AutoSave.asp?Action=AutoSave&FrameName=NewsContent&EnFrameName=EnNewsContent"></script>
  <%end if%></td>
</tr>
<!--<tr>
