...
<div class="right_frame_2">
                  <div class="right_top_2">>政务信息</div>
                      <div class="news_content">
                        ...
                        %>  
                             <li><span style=" float:right;"><%=GetPostTimeL(rs("ID"))%></span><a href="Inform_detail.asp?id=<%=rs("id")%>&classid=<%=rs("classid")%>" title="<%=rs("NewsTitle")%>" target="_blank"><%
