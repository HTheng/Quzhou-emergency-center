...
<div class="right_frame_2">
                  <div class="right_top_2">>急救知识</div>
                      <div class="news_content">
                        ...
                        %>  
                             <li><span style=" float:right;"><%=GetPostTimeL(rs("ID"))%></span><a href="Dynamic_knowledge_detail.asp?id=<%=rs("id")%>&classid=<%=rs("classid")%>" title="<%=rs("NewsTitle")%>" target="_blank"><%
